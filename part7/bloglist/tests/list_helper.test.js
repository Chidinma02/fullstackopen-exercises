...
describe('favorite blog', () => {
  ...
  test('when list has only one blog, returns that blog (reduced)', () => {
  ...
  test('of a bigger list, returns the blog with the most likes (reduced)', () => {
...
describe('most likes', () => {
  ...
  test('of a bigger list, returns the author with the most total likes', () => {
